// Binarytree.cpp : Diese Datei enthaelt die Funktion "main". Hier beginnt und endet die Ausfuehrung des Programms.
//
 ...
 */
void insertRandomNumber(int cfrn) //cfr: countforrandomnumber
{
...
/*
 * In insertOwnNumber() the number you want to be inserted is inserted.
 */
void insertownNumber(int nfrn) //nfrn: numberforownnumber
{
	if (nfrn > maxnumber)
	{
		maxnumber = nfrn;
...
/*
 * Works exactly like deleteTree() but without runtime measurement.
 */
void deleteTestTree()
{
...
//   5. Wechseln Sie zu "Projekt" > "Neues Element hinzufuegen", um neue Codedateien zu erstellen, bzw. zu "Projekt" > "Vorhandenes
//      Element hinzufuegen", um dem Projekt vorhandene Codedateien hinzuzufuegen.
